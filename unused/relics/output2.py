def format(final_list,errors,parsing,show_errors):
    ...
    output.write('<!DOCTYPE html><html lang="en-US"><head><meta charset="utf-8"><title>Analysis Sheet</title><link rel="stylesheet" type="text/css" href="sheet.css"></head><body><h1>Analysis Sheet</h1><p id="Center">Center</p><input type="checkbox"><p id="Embed">Embed Errors</p><input type="checkbox"><form><div id="sheet">')
